...
#   ./package_plugin.sh --name qgis_notebook     # Custom plugin name
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "Options:"
            echo "  --name, -n NAME       Plugin name for zip folder (default: qgis_notebook)"
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║         QGIS Notebook Plugin Packager                    ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
