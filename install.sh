#!/bin/bash
# Installation script for QGIS Notebook Plugin
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: qgis_notebook)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the qgis_notebook folder to your QGIS plugins directory."
    exit 1
fi
...
echo "╔══════════════════════════════════════════════════════════╗"
echo "║           QGIS Notebook Plugin Installer                 ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo ""
