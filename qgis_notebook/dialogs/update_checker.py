"""
Update Checker Dialog for QGIS Notebook Plugin
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="qgis_notebook_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "qgis_notebook.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "qgis_notebook.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("QGIS Notebook Update")
    ...
    def _setup_ui(self):
        ...
        self.current_version_label.setStyleSheet("font-weight: bold; color: #BCBEC4;")
        version_layout.addRow("Current Version:", self.current_version_label)

        self.latest_version_label = QLabel("Not checked")
        self.latest_version_label.setStyleSheet("color: #6E7274;")
        ...
        self.status_label.setStyleSheet("color: #6E7274;")
    ...
    def check_for_updates(self):
        ...
        self.status_label.setStyleSheet("color: #6897BB;")
        self.latest_version_label.setText("Checking...")
        self.latest_version_label.setStyleSheet("color: #6897BB;")
    ...
    def _on_check_error(self, error_msg):
        ...
        self.latest_version_label.setStyleSheet("color: #FF6B68;")
        self.status_label.setText(f"Error: {error_msg}")
        self.status_label.setStyleSheet("color: #FF6B68;")
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"QGIS Notebook has been updated to version {self.latest_version}.\n\n"
